...
REST_FRAMEWORK = {
    ...
    "DEFAULT_PAGINATION_CLASS": "albergue.pagination.CustomPageNumberPagination",
    "PAGE_SIZE": 2,
}
...
MIDDLEWARE = [
    "demo_django.middlewares.JWTAuthCookieMiddleware",
...
AUTH_USER_MODEL = "albergue.Usuario"
